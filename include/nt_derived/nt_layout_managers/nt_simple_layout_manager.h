...
struct NTSimpleLayoutManager
{
    ...
    struct NTObject* _container_child;
};
...
void nt_simple_layout_manager_set_container_child(const struct NTSimpleLayoutManager* simple_layout_manager, struct NTObject* object); // TODO
