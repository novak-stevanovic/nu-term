...
void _nt_hbox_calculate_next_child_constraints(struct NTBoxContainer* hbox_container,
    struct NTConstraints* next_child_constraints,
    struct NTBoxDataObject* data_obj);

void _nt_hbox_initialize_child_data_obj(struct NTBoxContainer* hbox_container,
    struct NTBoxChildDataObject* child_data_obj,
    struct NTConstraints* child_constraints,
    struct NTBoxDataObject* data_obj,
    struct NTObject* child);

void _nt_hbox_container_align_child(struct NTBoxContainer* hbox_container,
